    ...
    <div id="about" className='w-full md:h-full p-2 flex items-center py-16'>
      <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
        <div className='col-span-2'>
          ...
          <p className='py-2 text-gray-600'>I am a developing software engineer and I am currently completing a Bootcamp at General Assembly. As someone who loves to constantly problem solve and continuously evolve their skillset, software engineering feels like a dream.</p>
